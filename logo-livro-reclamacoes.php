<?php
/**
 * Plugin Name:          Compliance Logo and Link for Livro de Reclamações Eletrónico
 ...
 *
 * @since 1.0
 * @return Logo_Livro_Reclamacoes The singleton instance of the plugin class.
 */
function init_plugin() {
	// Load the main class.
	require_once 'includes/class-logo-livro-reclamacoes.php';
	// Return the singleton instance.
	return Logo_Livro_Reclamacoes::get_instance();
}
